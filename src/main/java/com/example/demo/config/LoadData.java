...
public class LoadData implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        new PatientMedicalInfo(1L, "TBD", "Cardiac Arrest", 1500, false),
        new PatientMedicalInfo(2L, "3", "Brain Aneurysm",1000,false),
        new PatientMedicalInfo(3L, "2", "Brain Aneurysm",1000,false),
        new PatientMedicalInfo(4L, "4", "Cardiac Arrest",1000,false),
        new PatientMedicalInfo(5L, "2", "Brain Aneurysm",1000,false),
        new PatientMedicalInfo(6L, "TBD", "Brain Aneurysm",500,false),
        new PatientMedicalInfo(7L, "9", "Cardiac Arrest",750,false),
        new PatientMedicalInfo(8L, "7", "Cardiac Arrest",750,false)
        ));
